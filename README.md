...
**wget http://samtools.github.io/hts-specs/VCFv4.2.pdf**
...
**cut -d "	" -f1 NA12878.variants.vcf | sort -n | uniq**
...
**cut -d "	" -f 10 NA12878.variants.vcf | cut -d : -f 1**
...
**cut -d "	" -f 10 NA12878.variants.vcf | cut -d : -f 1 | sort | uniq**
...
**echo ";gene_symbol=PTEN;gene_name=phospho;gene_sequence=atc;" | match.py -r "gene_symbol=(.*?);gene_sequence=(.*?);"**
